 ...
 * @Author qbatyqi
 *
 * @param {Object}      opts                鍙傛暟闆�
 * @param {Element}     opts.dom            澶栧眰鍏冪礌        Outer wrapper
 * @param {Object}      opts.data           鏁版嵁鍒楄〃        Content data
 * Please refer to README                   璇峰弬鑰僐EADME
 * @class 
 */
 ...
 * animation parmas: 
 *
 * @param {Element}      dom             鍥剧墖鐨勫灞�<li>瀹瑰櫒       Img wrapper
 * @param {String}       axis            鍔ㄧ敾鏂瑰悜                animate direction
 * @param {Number}       scale           瀹瑰櫒瀹藉害                Outer wrapper
 * @param {Number}       i               <li>瀹瑰櫒index           Img wrapper's index
 * @param {Number}       offset          婊戝姩璺濈                move distance
 */
