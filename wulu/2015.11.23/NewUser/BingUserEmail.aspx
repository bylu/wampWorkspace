<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BingUserEmail.aspx.cs" Inherits="Game.Web.NewUser.BingUserEmail" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#BingUserEmail").addClass("lanmu-list_default");
                            ...
                            <div class="offi-regi-form">
                                <table cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="Submit" runat="server" Text="绑定" CssClass="register-btn" OnClick="Submit_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
