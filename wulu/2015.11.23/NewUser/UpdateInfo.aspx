<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateInfo.aspx.cs" Inherits="Game.Web.NewUser.UpdateInfo" %>
...
<script type="text/javascript">
    function load() {
        document.getElementById("UpdateInfo").className = "lanmu-list_default";
    }
    </script>
</head>
<body onload="load()">
            ...
            <div class="sidebar_right">
                ...
                <div class="wfjs" style="overflow: hidden;">
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td align="right">
                                <asp:Button ID="btnUpdate" runat="server" OnClientClick="return checkInput()" CssClass="btn1 bold"
                                    Text="" Height="25px" OnClick="btnUpdate_Click" Style="background-image: url('/templets/New/images/btn_ok.jpg'); width: 92px; height: 35px;" />
                            </td>
                        </tr>
                    </table>
                </div>
