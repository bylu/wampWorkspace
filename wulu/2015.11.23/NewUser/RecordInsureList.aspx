<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordInsureList.aspx.cs" Inherits="Game.Web.NewUser.RecordInsureList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function load() {
            document.getElementById("RecordInsureList").className = "lanmu-list_default";
        }
    </script>
</head>
<body onload="load()">
                    ...
                    <div class="box">
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr style="line-height: 50px;">
                                ...
                                <td width="10%">
                                    <asp:TextBox ID="txtStartDate" runat="server" CssClass="text" Width="70" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'txtEndDate\')}'})"></asp:TextBox>
                                </td>
                                <td width="6%">
                                    <img src="/templets/images/btn_calendar.gif" onclick="WdatePicker({el:'txtStartDate',skin:'whyGreen',dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'txtEndDate\')}'})"
                                        style="cursor: pointer; vertical-align: middle" />
                                </td>
                                <td width="3%">至
                                </td>
                                <td width="10%">
                                    <asp:TextBox ID="txtEndDate" runat="server" CssClass="text" Width="70" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'txtStartDate\')}'})"></asp:TextBox>
                                </td>
                                <td width="7%">
                                    <img src="/templets/images/btn_calendar.gif" onclick="WdatePicker({el:'txtEndDate',skin:'whyGreen',dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'txtStartDate\')}'})"
                                        style="cursor: pointer; vertical-align: middle" />
                                </td>
                                <td width="10%">
                                ...
                                <td>
                                    <asp:Button ID="btnQuery" runat="server" Text="查询" CssClass="btn" OnClick="btnQuery_Click" Style="width: 90px; height: 33px;" />
                                    <input type="button" name="btnRefresh" value="刷新" class="btn" onclick="window.location.href = location.href;" style="width: 90px; height: 33px;" />
                                </td>
                            </tr>
                        </table>
