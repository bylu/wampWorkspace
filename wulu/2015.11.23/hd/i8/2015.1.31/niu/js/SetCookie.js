...
function getTimestamp() {
	...
	var math = timestamp + Math.round(Math.random() * 3000);
	return math;
}
...
}else if(referrer!='' && referer.indexOf("789game.com") < 0 && referer.indexOf("789game.net") < 0 ){
...
$.ajax({
	...
	url : "http://tongji.789game.net:8081/tj/data/collect",
