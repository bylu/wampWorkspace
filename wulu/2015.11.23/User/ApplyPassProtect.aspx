<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplyPassProtect.aspx.cs" Inherits="Game.Web.User.ApplyPassProtect" %>
        ...
        <div id="content">
            <div class="sidebar_right">
                ...
                <div class="wfjs" style="overflow: hidden;">
                    ...
                    <div runat="server" id="frmProtect">
                        ...
                        <div class="formbox">
                            ...
                            <div class="item">
                                ...
                                <div class="fl">
                                    ...
                                    <span id="lblPassportID"></span>

                                </div>
                            </div>
                            <div class="item">
                                <span class="label">确认号码：</span>
                                <div class="fl">
                                    <asp:TextBox ID="txtConPassportID" runat="server"></asp:TextBox>
                                    <span id="lblConPassportID"></span>
                            ...
                            <div class="item">
                                ...
                                <div class="fl" style="padding-left: 100px;">
                                    <asp:Button ID="btnConfirm" runat="server"
                                        Text="" CssClass="btn" OnClick="btnConfirm_Click" Style="width: 91px; height: 35px; background-image: url('/templets/New/images/qd.png');" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="submit" name="Submit2" value="" class="btn" style="width: 91px; height: 35px; background-image: url('/templets/New/images/qx.png');" />
