<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetLoginPass.aspx.cs" Inherits="Game.Web.User.ResetLoginPass" %>
                        ...
                        <tr style="text-align: left;">
                            <td style="text-align: center">
                                <asp:Button ID="btnConfirm1" runat="server" OnClientClick="return CheckAccounts()"
                                    Text="" CssClass="btn" OnClick="btnConfirm1_Click" Style="background-image: url('/templets/new/images/btn_ok.jpg'); background-repeat: no-repeat; width: 90px; height: 35px;" />
                                <input type="reset" name="Submit2" value="" class="btn" style="background-image: url('/templets/new/images/btn_reset.jpg'); background-repeat: no-repeat; width: 90px; height: 35px;" />
